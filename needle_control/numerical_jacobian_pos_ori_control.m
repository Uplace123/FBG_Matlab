function du = numerical_jacobian_pos_ori_control(xd, Kp, ic, sb, l, ti, Nel, Mu, Alpha, Interval, NumChannel, NumAA, interrogator, RefData, AA_lcn,FBG_switch, d_init)
...
[ds, ks, ~] = S.function(S.sb, S.l, u(1), u(2), S.ti, S.Nel, S.Mu, S.Alpha,S.Interval,S.NumChannel,S.NumAA,S.interrogator,S.RefData,S.AA_lcn,FBG_switch, d_init);
y = zeros(2, 1);
y(1) = ds(end);
y(2) = ks(end);
end
