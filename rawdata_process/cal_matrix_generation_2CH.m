...
for tri = 1:5 % five trials
    ...
    fbg_unbent_0d = readmatrix('calibration.xls','Sheet',strcat(sheet_name_unbent,'_0deg'));
    fbg_unbent_90d = readmatrix('calibration.xls','Sheet',strcat(sheet_name_unbent,'_90deg'));
    ...
    for i = 0:4 % five curves (excluding straight)
        ...
        fbg_curve_0d = readmatrix('calibration.xls','Sheet',strcat(sheet_name,'_0deg')) - fbg_unbent_0d;        
        fbg_0d(i+1,:) = mean(fbg_curve_0d);
    
        fbg_curve_90d = readmatrix('calibration.xls','Sheet',strcat(sheet_name,'_90deg')) - fbg_unbent_90d;
